...
<div style="float: right; width: 40%; margin: 0 0 1em 1em; padding: 1em; border: 1px solid #faebcc; background-color:#fcf8e3; font-size: 1.2em">The DXAC is making uninformed decisions that adversely affect every one of us. Please "contact your regional DXAC representative":dxac and let them know that section I.9 of the DXCC rules should NOT be changed to restrict remote station use.</div>
...
<div style="margin: 1em; padding: 1em; border: 1px solid #faebcc; background-color:#fcf8e3; font-size: 1.2em">Please "contact your regional DXAC representative":dxac and let them know that section I.9 of the DXCC rules should NOT be changed to restrict remote station use.</div>
